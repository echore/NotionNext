...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lyc', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '梦想是吃好睡好，身心健康；为性别平等做出贡献🎉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lycsplanet.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,lyc', // 网站关键词 英文逗号隔开
